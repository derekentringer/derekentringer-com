...
- Package structure: `api/`, `web/`, `fin-api/`, `fin-web/`, `shared/`, `mobile/` (deferred)
...
- `packages/fin-api/` — Fastify server with `GET /health` endpoint
- `packages/fin-web/` — React + Vite SPA with dashboard placeholder and 404 page

...
A Table of Contents (TOC) tab in the right-side drawer (alongside AI Assistant and Version History) that shows document structure from markdown headings and allows click-to-scroll navigation in the preview pane.

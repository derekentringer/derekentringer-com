...
### InteractiveTable Component (`ns-web`)
...
### MarkdownPreview Integration (`ns-web`)
...
| File | Change |
|------|--------|
| `packages/ns-web/src/lib/tableMarkdown.ts` | **New** — Table parsing, serialization, cell update, sort |
| `packages/ns-web/src/components/InteractiveTable.tsx` | **New** — Self-rendering interactive table component |
| `packages/ns-web/src/components/MarkdownPreview.tsx` | Added `table` component override with stable refs, `useRef` for content/onContentChange |
| `packages/ns-web/src/styles/global.css` | Added sortable header + editable cell + edit input CSS |

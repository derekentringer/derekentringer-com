...
| File | Change |
|------|--------|
| `packages/ns-web/package.json` | Added `rehype-highlight` + `highlight.js` dependencies |
| `packages/ns-web/src/components/MarkdownPreview.tsx` | Added `rehypeHighlight` import and `rehypePlugins` prop |
| `packages/ns-web/src/components/QAPanel.tsx` | Added `rehypeHighlight` import and `rehypePlugins` prop |
| `packages/ns-web/src/styles/global.css` | Added hljs theme variables (dark + light) and syntax token CSS rules |

...
### MarkdownPreview Refactor (`ns-web`)
...
| File | Change |
|------|--------|
| `packages/ns-web/src/components/CodeBlock.tsx` | New — copy button wrapper component |
| `packages/ns-web/src/components/MarkdownPreview.tsx` | Refactored markdownComponents to always build, added `pre: CodeBlock` |
| `packages/ns-web/src/styles/global.css` | Added `.code-block-wrapper` / `.code-block-copy` CSS |

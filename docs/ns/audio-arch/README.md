...
| [1](02-phase-1-resource-lifecycle.md) | partial (TS 1.0/1.1/1.4/1.5/1.6 shipped; Rust 1.2/1.3 reverted) | Plug temp file, stream, and thread leaks on all code paths | 0 |
| [2](03-phase-2-state-machine-races.md) | mostly shipped (2.2 Rust doc comment reverted) | Eliminate stop-during-start, start-during-stop, race-prone refs | 0 |
| [3](04-phase-3-transcript-correctness.md) | ✅ shipped (3.1–3.6) | Fix chunk ordering, dedup, Whisper retry semantics, session cleanup | 0 |
| [4](05-phase-4-performance.md) | ✅ shipped (4.1–4.5, 4.1 revert-then-re-land) | Parallelize, deduplicate API calls, optimize live chunking | 1–3 complete |
| [5](06-phase-5-test-coverage.md) | ✅ shipped (5.1–5.6) | Close test gaps, add integration tests for meeting mode | 1–4 complete |

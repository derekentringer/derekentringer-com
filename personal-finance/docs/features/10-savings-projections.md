...
- **Stacked area chart**: Principal (violet) vs. Interest (green) over time (strokeWidth 1.5, fillOpacity 0.6 for stacked visibility); tooltip entries sorted by value descending with total row

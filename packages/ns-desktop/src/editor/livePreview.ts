...
class TableWidget extends WidgetType {
  ...
  toDOM(view: EditorView) {
    ...
    wrapper.setAttribute("aria-label", "Rendered markdown table — click to edit");
      ...
      switch (node.type.name) {
        ...
        case "Table": {
          ...
          if (firstLine.to > firstLine.from) {
            ...
            decorations.push(Decoration.line({ class: "cm-lp-table-host" }).range(firstLine.from));
          }
...
const livePreviewTheme = EditorView.baseTheme({
  ...
  ".cm-lp-code": {
    ...
    backgroundColor: "var(--color-subtle, rgba(128, 128, 128, 0.15))",
    borderRadius: "3px",
    padding: "1px 4px",
  },
...
export { buildDecorations as _buildDecorations };

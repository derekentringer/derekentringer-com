            ...
            <SettingsGroup>
              ...
              {aiSettings.qaAssistant && aiSettings.masterAiEnabled && (
                <div className="pt-2 px-3 space-y-1 border-t border-border/50">
                  ...
                  <ToggleSwitch label="Delete notes (to trash)" checked={aiSettings.autoApprove.deleteNote} onChange={(v) => updateAiSetting("autoApprove", { ...aiSettings.autoApprove, deleteNote: v })} info="Auto-approve `delete_note` calls. Notes go to Trash and can be restored for 30 days." />
